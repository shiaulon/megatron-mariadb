...
class RelRGVendedorOuAtendente extends StatefulWidget {
  const RelRGVendedorOuAtendente({super.key});

  @override
  State<RelRGVendedorOuAtendente> createState() => _RelRGVendedorOuAtendenteState();
}
...
class _RelRGVendedorOuAtendenteState extends State<RelRGVendedorOuAtendente> {
