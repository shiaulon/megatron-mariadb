...
class RelCNPJInscricao extends StatefulWidget {
  const RelCNPJInscricao({super.key});

  @override
  State<RelCNPJInscricao> createState() => _RelCNPJInscricaoState();
}
...
class _RelCNPJInscricaoState extends State<RelCNPJInscricao> {
