...
class RelFornecedorInativosPeriodo extends StatefulWidget {
  const RelFornecedorInativosPeriodo({super.key});

  @override
  State<RelFornecedorInativosPeriodo> createState() => _RelFornecedorInativosPeriodoState();
}
...
class _RelFornecedorInativosPeriodoState extends State<RelFornecedorInativosPeriodo> {
                                ...
                                children: [
                                  Padding( // Título "Rel OSM em Aberta"
                                    ...
                                    child: Center( // <-- NOVO: Centraliza o texto APENAS dentro deste Expanded
                                      child: Text(
                                        'REL. FORNECEDOR INATIVOS P/ PERÍODO',
                                        style: TextStyle(
                                          fontSize: 28,
