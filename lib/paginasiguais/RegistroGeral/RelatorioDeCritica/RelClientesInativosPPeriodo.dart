...
class RelClientesInativosPeriodo extends StatefulWidget {
  const RelClientesInativosPeriodo({super.key});

  @override
  State<RelClientesInativosPeriodo> createState() => _RelClientesInativosPeriodoState();
}
...
class _RelClientesInativosPeriodoState extends State<RelClientesInativosPeriodo> {
                                ...
                                children: [
                                  Padding( // Título "Rel OSM em Aberta"
                                    ...
                                    child: Center( // <-- NOVO: Centraliza o texto APENAS dentro deste Expanded
                                      child: Text(
                                        'REL. CLIENTES INATIVOS P/ PERÍODO',
                                        style: TextStyle(
                                          fontSize: 28,
