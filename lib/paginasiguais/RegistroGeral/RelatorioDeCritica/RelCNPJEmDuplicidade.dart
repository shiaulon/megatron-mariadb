...
class RelCNPJEmDuplicidade extends StatefulWidget {
  const RelCNPJEmDuplicidade({super.key});

  @override
  State<RelCNPJEmDuplicidade> createState() => _RelCNPJEmDuplicidadeState();
}
...
class _RelCNPJEmDuplicidadeState extends State<RelCNPJEmDuplicidade> {
