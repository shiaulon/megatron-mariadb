...
class RelDivergenciaCNPJ extends StatefulWidget {
  const RelDivergenciaCNPJ({super.key});

  @override
  State<RelDivergenciaCNPJ> createState() => _RelDivergenciaCNPJState();
}
...
class _RelDivergenciaCNPJState extends State<RelDivergenciaCNPJ> {
                                ...
                                children: [
                                  Padding( // Título "Rel OSM em Aberta"
                                    ...
                                    child: Center( // <-- NOVO: Centraliza o texto APENAS dentro deste Expanded
                                      child: Text(
                                        'REL. DIVERGÊNCIA CNPJ / INSCRIÇÃO',
                                        style: TextStyle(
                                          fontSize: 28,
