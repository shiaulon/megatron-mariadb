...
class GeraArquivoExcellEmail extends StatefulWidget {
  const GeraArquivoExcellEmail({super.key});

  @override
  State<GeraArquivoExcellEmail> createState() => _GeraArquivoExcellEmailState();
}
...
class _GeraArquivoExcellEmailState extends State<GeraArquivoExcellEmail> {
