...
class ContatosGeralListaContatos extends StatefulWidget {
  const ContatosGeralListaContatos({super.key});

  @override
  State<ContatosGeralListaContatos> createState() => _ContatosGeralListaContatosState();
}
...
class _ContatosGeralListaContatosState extends State<ContatosGeralListaContatos> {
