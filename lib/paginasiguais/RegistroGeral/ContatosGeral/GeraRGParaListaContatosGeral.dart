...
class GeraRGParaListaContatosGeral extends StatefulWidget {
  const GeraRGParaListaContatosGeral({super.key});

  @override
  State<GeraRGParaListaContatosGeral> createState() => _GeraRGParaListaContatosGeralState();
}
...
class _GeraRGParaListaContatosGeralState extends State<GeraRGParaListaContatosGeral> {
                                ...
                                children: [
                                  Padding( // Título "Rel OSM em Aberta"
                                    ...
                                    child: Center( // <-- NOVO: Centraliza o texto APENAS dentro deste Expanded
                                      child: Text(
                                        'GERA RG PARA LISTA CONTATOS GERAL',
                                        style: TextStyle(
                                          fontSize: 28,
