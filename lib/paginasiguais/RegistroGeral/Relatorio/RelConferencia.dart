...
class RelConferencia extends StatefulWidget {
  const RelConferencia({super.key});

  @override
  State<RelConferencia> createState() => _RelConferenciaState();
}
...
class _RelConferenciaState extends State<RelConferencia> {
