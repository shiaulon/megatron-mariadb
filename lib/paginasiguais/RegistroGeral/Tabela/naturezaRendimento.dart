...
class _TabelaNaturezaRendimentoState extends State<TabelaNaturezaRendimento> {
  ...
  void initState() {
    ...
    _codigoNatRendimento.addListener(_updateEmpresaCounter);
                                ...
                                children: [
                                  Padding(
                                    ...
                                    child: Center(
                                      ...
                                      child: Text(
                                        'Natureza Rendimento', // Título alterado para "Controle"
                                        style: TextStyle(
                                          fontSize: 28,
                          ...
                          children: [
                            ...
                            Expanded(
                              child: CustomInputField(
                                ...
                                suffixText: '${_codigoNatRendimento.text.length}/5',
                                validator: (value) {
                                  if (value == null || value.isEmpty) {
                                    return 'Campo obrigatório';
                                  }
                                  if (value.length != 5) {
                                                        return 'A sigla deve ter exatamente 5 dígitos.';
                                                }
                                                return null;
                                },
                              ),
                                ...
                                child: ElevatedButton(
                                  onPressed: () {
                                    ...
                                    if (_formKey.currentState?.validate() ?? false) {
                                      ...
                                      print('codigo Cargo: ${_codigoNatRendimento ?? 'Nenhum selecionado'}');
